...
import altamir.android.santander.com.br.bankapp.classes.CarregaTransacoes;
import altamir.android.santander.com.br.bankapp.classes.ViewAdapter;
import okhttp3.Call;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<CarregaTransacoes> transacoesList;
    ...
    //carrega dados do postman do Builder().url("https://bank-app-test.herokuapp.com/api/statements/1")
        ...
        call.enqueue(new Callback() {
           @Override
            public void onFailure( Call call, IOException e) {
                Toast.makeText(MainActivity.this, "Erro ao carregar a aplicação", Toast.LENGTH_LONG).show();
            ...
            public void onResponse( Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    for(int i=0;i<=result.length();i++)
                                    {
                                        ...
                                        CarregaTransacoes carregaTransacoes =
                                                new CarregaTransacoes(jsonObject.getString("title"),
                                                                      jsonObject.getString("desc"),
                                                                      jsonObject.getString("date"),
                                                                      jsonObject.getDouble("value"));
                                        transacoesList.add(carregaTransacoes);
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                                adapter = new ViewAdapter(getApplicationContext(), transacoesList);
                    ...
                    Toast.makeText(MainActivity.this, "Erro na hora de carregar o onResponse", Toast.LENGTH_LONG).show();
                    pbarrecentes.setVisibility(View.GONE);
                }
            }
        });
