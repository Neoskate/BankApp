...
import altamir.android.santander.com.br.bankapp.R;

public class ViewAdapter extends RecyclerView.Adapter<ViewAdapter.ViewHolder> {

    private Context context;
    private List<CarregaTransacoes> recentesList;
    private Locale ptBr = new Locale("pt", "BR");

    public ViewAdapter(Context context, List<CarregaTransacoes> recentesList) {
